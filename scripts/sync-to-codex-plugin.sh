  ...
  cat > "$dest" <<EOF
{
  ...
  "homepage": "https://github.com/xuansheep/superpowers-spec",
...
Upstream commit: https://github.com/xuansheep/superpowers-spec/commit/$UPSTREAM_SHA
...
Upstream: https://github.com/xuansheep/superpowers-spec/commit/$UPSTREAM_SHA
Branch:   $SYNC_BRANCH"
