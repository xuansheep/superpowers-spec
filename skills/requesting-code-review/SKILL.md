...
description: "Use when an approved brainstorming workflow allows non-brainstorming skills and completing tasks, implementing major features, or before merging to verify work meets requirements"
---
...
Use Task tool with `general-purpose` type, fill template at `skills/requesting-code-review/code-reviewer.md`.
